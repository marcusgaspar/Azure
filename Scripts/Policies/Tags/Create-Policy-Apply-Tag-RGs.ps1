...
foreach ($row in $TagData) {
    ...
    while ($true){
        ...
        if ($null -ne $Principal) {
            ...
            Write-Host "The $PrincipalID application exists."
            break
        } else {
    ...
    New-AzRoleAssignment -ObjectId $PrincipalID -RoleDefinitionName Contributor -Scope $PolicyScope 
